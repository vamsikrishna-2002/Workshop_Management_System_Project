...
export default function WorkshopsInstructorPage() {
    ...
    <div className="container mx-auto">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">View all the workshops</p>
        </div>
      </div>
      ...
      {workshops.length === 0 ? (
        <div className="rounded-lg border-2 border-dashed border-gray-300 p-12">
          <div className="text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">No workshops found</p>
          </div>
        </div>
      ) : (
            ...
            >
              ...
              <div className="bg-gray-50 px-6 py-3">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    to={`/instructor/workshops/${workshop.id}/view`}
